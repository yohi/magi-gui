...
2.  **System Instructions (システム指示) の入力**:
    ...
    > **Note:** 本プロジェクトにおける各賢者の正式なプロンプト定義は、`magi-core` パッケージ内の[ソースコード](https://github.com/yohi/magi-core/blob/master/src/magi/agents/persona.py)を参照してください。
...
詳細なペルソナ定義は [https://github.com/yohi/magi-core/blob/master/src/magi/agents/persona.py](https://github.com/yohi/magi-core/blob/master/src/magi/agents/persona.py) で管理されています。
...
def main():
    ...
    # 3賢者の初期化
    # プロンプトの完全な定義は magi-core/src/magi/agents/persona.py を参照してください
